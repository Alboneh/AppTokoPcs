...
class M_item_transaksi extends CI_Model {
	...
	{
		$this->db->select('item_transaksi.id,item_transaksi.transaksi_id,item_transaksi.produk_id,produk_id,produk.nama,item_transaksi.qty,item_transaksi.harga_saat_transaksi,item_transaksi.sub_total');
